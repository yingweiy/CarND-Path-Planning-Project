      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // j[1] is the data JSON object
            ...
            //minimize the jerk: smooth the path - spline polynomial
            ...
            if (prev_size<2)
            {
                double prev_car_x = car_x - cos(car_yaw); //go back and insert points along tangent direction
            ...
            } else
            {
                ...
                //use two points that make the path tangent to the prvious path's end point
            ...
            {
                //shift the car angle to 0 degree
            ...
            //define teh actual (x,y) points we will use for the planner
            ...
            for (int i=1; i<=50-previous_path_x.size(); i++)
            {
                ...
                // inverse transform from car coordinate to global coordinate
